 ...
 *管理员组表基础model
 */
class logistics_goodsModel extends BaseModel{
    protected $tableName = 'logistics_goods';
    // 自动验证
    protected $_validate=array(
        //必填验证
        array('from_province','require','出发地必须填写',0,'',3),
        array('from_city','require','出发地必须填写',0,'',3),
        array('from_area','require','出发地必须填写',0,'',3),
        array('to_province','require','到达地必须填写',0,'',3),
        array('to_city','require','到达地必须填写',0,'',3),
        array('to_area','require','到达地必须填写',0,'',3),
        array('coal_type','require','煤种不能为空',0,'',3),
        array('price','require','运费运费不能为空',0,'',3),
        array('quantity','require','重量不能为空',0,'',3),
        array('tip_type','require','收费类型不能为空',0,'',3),
        array('tip','require','收费金额不能为空',0,'',3),
        array('writer_id','require','发布者不能为空',0,'',3),
        //唯一性验证
